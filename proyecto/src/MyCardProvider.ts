...
export class MyCardProvider extends LitElement {
    
    @property({ type: Array }) listita = new Array<MyCard>();
    ...
    render() {
      return html`
        ...
        <!--fontawesome-->
                <div class="card" @click=${this._addCard}>
                    <div class="card-body ">
                        <i class="fa fa-users"></i>
                        <h5 class="card-title">HOLAA</h5>
                        <p class="card-text">ajsdkjask</p>
                    </div>
                </div>
                ${this.listita.map(item => 
                    html`
                    <div class="card">
                        <div class="card-body ">
                            <i class="fa fa-users"></i>
  ...
  window.customElements.define('my-cardprovider', MyCardProvider);